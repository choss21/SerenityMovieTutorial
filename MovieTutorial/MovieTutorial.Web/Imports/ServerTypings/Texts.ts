    ...
    declare namespace Db {
        ...
        namespace MovieDB {
            ...
            namespace Movie {
                ...
                export const StateCountryName: string;
                export const Storyline: string;
                export const Title: string;
                export const TitleUpper: string;
                export const Year: string;
            }

            namespace StateCountry {
                export const CountryId: string;
                export const CountryName: string;
                export const Name: string;
                export const StateCountryId: string;
